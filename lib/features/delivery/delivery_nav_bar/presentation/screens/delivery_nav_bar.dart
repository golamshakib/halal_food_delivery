...
import '../../controllers/delivery_nav_bar_controller.dart';

class DeliveryNavBar extends StatelessWidget {
  DeliveryNavBar({super.key});

  final controller = Get.put(DeliveryNavBarController());

  @override
  Widget build(BuildContext context) {
    return GetBuilder<DeliveryNavBarController>(
      builder: (controller) {
        return Scaffold(
  ...
  Widget buildNavItem({
    ...
    required int index,
    required DeliveryNavBarController controller,
    double? height,
    double? width,
  }) {
