...
import '../../controllers/delivery_edit_profile_controller.dart';

class DeliveryEditProfileScreen extends StatelessWidget {
  DeliveryEditProfileScreen({super.key});
  final controller = Get.put(DeliveryEditProfileController());
