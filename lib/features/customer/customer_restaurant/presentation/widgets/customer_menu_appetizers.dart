...
import '../../controllers/customer_menu_appetizers_controller.dart';

class CustomerMenuAppetizers extends StatelessWidget {
  CustomerMenuAppetizers({super.key});
  final controller = Get.put(CustomerMenuAppetizersController());
