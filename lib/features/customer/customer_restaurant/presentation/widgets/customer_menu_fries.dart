...
import '../../controllers/customer_menu_fries_controllor.dart';

class CustomerMenuFries extends StatelessWidget {
  CustomerMenuFries({super.key});
  final controller = Get.put(CustomerMenuFriesController());
