...
import '../../controllers/customer_menu_burger_controller.dart';

class CustomerMenuBurger extends StatelessWidget {
  CustomerMenuBurger({super.key});
  final controller = Get.put(CustomerMenuBurgerController());
