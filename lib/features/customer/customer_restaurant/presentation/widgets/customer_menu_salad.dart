...
import '../../controllers/customer_menu_salad_controller.dart';

class CustomerMenuSalad extends StatelessWidget {
  CustomerMenuSalad({super.key});
  final controller = Get.put(CustomerMenuSaladController());
