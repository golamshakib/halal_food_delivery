...
import '../../controllers/customer_menu_other_controller.dart';

class CustomerMenuOther extends StatelessWidget {
  CustomerMenuOther({super.key});
  final controller = Get.put(CustomerMenuOtherController());
