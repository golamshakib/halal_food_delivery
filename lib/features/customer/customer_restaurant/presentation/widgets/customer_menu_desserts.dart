...
import '../../controllers/customer_menu_desserts_controller.dart';

class CustomerMenuDesserts extends StatelessWidget {
  CustomerMenuDesserts({super.key});
  final controller = Get.put(CustomerMenuDessertsController());
