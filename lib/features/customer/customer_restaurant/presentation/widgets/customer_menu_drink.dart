...
import '../../controllers/customer_menu_drink_controller.dart';

class CustomerMenuDrink extends StatelessWidget {
  CustomerMenuDrink({super.key});
  final controller = Get.put(CustomerMenuDrinkController());
