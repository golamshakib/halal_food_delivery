...
import 'customer_logout_bottom_sheet.dart';

class CustomerProfileList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      _ListItem(
        ...
        text: "Your profile",
        onPressed: () {
          Get.toNamed(AppRoute.customerEditProfileScreen);
        },
      ),
      _ListItem(
        icon: IconPath.key,
        ...
        onPressed: () {
          Get.toNamed(AppRoute.customerChangePasswordScreen);
        },
      ),
      _ListItem(
        icon: IconPath.lock,
        text: "Privacy Policy",
        onPressed: () {
          Get.toNamed(AppRoute.customerPolicyScreen);
        },
      ),
      _ListItem(
        icon: IconPath.user,
        ...
        showDivider: false,
        onPressed: () {
          CustomerLogoutBottomSheet.showCustomerLogoutBottomSheet(context);
        },
      ),
    ];
