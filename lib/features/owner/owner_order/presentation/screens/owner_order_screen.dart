...
import '../../controller/owner_order_controller.dart';
import '../widgets/owner_completed.dart';
import '../widgets/owner_ongoing.dart';
import '../widgets/owner_preparing.dart';

class OwnerOrderScreen extends StatelessWidget {
  OwnerOrderScreen({super.key});

  final OwnerOrderController controller = Get.put(OwnerOrderController());
