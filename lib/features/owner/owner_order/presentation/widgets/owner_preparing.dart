...
import '../../controller/owner_preparing_controller.dart';
import 'owner_order_product.dart';

class OwnerPreparing extends StatelessWidget {
  OwnerPreparing({super.key});
  final OwnerPreparingController controller = Get.put(
    OwnerPreparingController(),
  );
