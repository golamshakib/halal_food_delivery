...
import '../screens/owner_add_menu_screen.dart';
...
class OwnerProfileList extends StatelessWidget {
  const OwnerProfileList({super.key});
  ...
  Widget build(BuildContext context) {
    final items = [
      ...
      _ListItem(
        ...
        text: "Privacy Policy",
        onPressed: () {
          Get.toNamed(AppRoute.ownerPolicyScreen);
        },
      ),
      _ListItem(
        icon: IconPath.user,
        ...
        showDivider: false,
        onPressed: () {
          OwnerLogoutBottomSheet.showOwnerLogoutBottomSheet(context);
        },
      ),
    ];
